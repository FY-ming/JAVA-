...
public class AdministratorDesigner extends JFrame {
    ...
    public AdministratorDesigner(GUImain loginFrame, User user, Client appl) {
    ...
    private void initComponents() {
        ...
        //======== menuBar1 ========
        {
            ...
            //======== menu3 ========
            {
                ...
                menuItem1.addActionListener(e -> new setUsersInfo(this,user.getName(),application).setVisible(true));
                menu3.add(menuItem1);

                //---- menuItem5 ----
                menuItem5.setText("新增用户");
                menuItem5.addActionListener(e -> new addUser(this,application).setVisible(true));
                menu3.add(menuItem5);

                //---- menuItem6 ----
                menuItem6.setText("删除用户");
                menuItem6.addActionListener(e -> new deleteUser(this,user.getName(),application).setVisible(true));
                menu3.add(menuItem6);
